          ...
          nginxConf = pkgs.writeText "nginx.conf" ''
            ...
            http {
              ...
              server {
                ...
                add_header Content-Security-Policy "default-src 'none'; style-src 'self' 'unsafe-inline'; img-src 'self'; media-src 'self'; prefetch-src 'self'; upgrade-insecure-requests; block-all-mixed-content; sandbox; base-uri 'self'";
