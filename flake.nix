          ...
          nginxConf = pkgs.writeText "nginx.conf" ''
            ...
            http {
              ...
              server {
                ...
                add_header Content-Security-Policy "default-src 'none'; style-src 'self' 'unsafe-inline'; img-src 'self'; media-src 'self'; upgrade-insecure-requests; sandbox; base-uri 'self'";
